...
/**
 * Service for sending notification messages of type SKIP
 */
@Service
...
class SkipNotificationSenderServiceImpl(
    ...
    override fun notificationType() = NotificationType.SKIPPED

    override fun User.subscribed() = this.skipped ?: true
}
