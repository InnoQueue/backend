...
class ShakeNotificationSender(
    ...
    override fun notificationType() = NotificationType.SHOOK

    // TODO add column to DB
    override fun User.subscribed() = true
    override fun prepareNotificationsListToSend(notificationMessageDto: NotificationMessageDto): List<Notification> =
