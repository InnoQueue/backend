...
class UserServiceImpl(
     ...
     */
    @Transactional
    override fun findUserById(userId: Long): User? = userRepository.findByIdOrNull(userId)
     ...
     */
    @Transactional
    override fun findUserNameById(userId: Long): String? = userRepository.findByIdOrNull(userId)?.name
     ...
     */
    @Transactional
    override fun getUserSettings(token: String): UserDto = this.findUserByToken(token).let {
        UserDto(
            it.name!!,
            it.completed!!,
            it.skipped!!,
     ...
     */
    @Transactional
    override fun updateUserSettings(token: String, settings: UpdateUserDto): UserDto {
     ...
     */
    @Transactional
    override fun createNewUser(userName: String, fcmToken: String): TokenDto {
    ...
    private fun generateUserToken(): String {
        ...
        return StringGenerator(TOKEN_LENGTH, existingTokens).generateString()
    }
