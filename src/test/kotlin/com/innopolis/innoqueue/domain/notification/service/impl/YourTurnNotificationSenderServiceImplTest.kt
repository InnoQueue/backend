...
class YourTurnNotificationSenderServiceImplTest : PostgresTestContainer() {

    @Autowired
    private lateinit var notificationSenderService: YourTurnNotificationSenderServiceImpl
